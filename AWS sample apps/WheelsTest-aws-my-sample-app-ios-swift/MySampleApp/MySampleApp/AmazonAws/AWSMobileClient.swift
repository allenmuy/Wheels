...
class AWSMobileClient: NSObject {
    ...
    */
    ...
    func setupCloudLogicAPI() {
        ...
        AWSAPI_3PKFKS1RQC_WheelsTestMobileHubClient.register(with: serviceConfiguration!, forKey: AWSCloudLogicDefaultConfigurationKey)
        AWSAPI_M8K6OZAO1D_LocationsTestClient.register(with: serviceConfiguration!, forKey: AWSCloudLogicDefaultConfigurationKey)
        AWSAPI_8OP0MVGRMG_LocationTestvMobileHubClient.register(with: serviceConfiguration!, forKey: AWSCloudLogicDefaultConfigurationKey)
    }
